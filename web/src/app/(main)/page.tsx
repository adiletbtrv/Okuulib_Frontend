...
export default function HomePage() {
  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-6">
        ...
        {featuredBook ? (
          <PosterBanner
            ...
            description={
              featuredBook.description || t.home.heroDesc
            }
          ...
          <PosterBanner
            title={t.home.manasTitle}
            description={t.home.manasDesc}
        ...
        <div className="flex items-center justify-between mb-5">
          <div>
            <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#E84326] mb-1">
              ...
              <span>{t.home.bestCollections}</span>
            </div>
            <h2 className="text-xl sm:text-2xl font-extrabold tracking-tight text-[#1A1A2E] dark:text-white">
              {t.home.bestCollections}
            </h2>
          </div>
          <Link
            href="/catalog"
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
            {genres.map((g) => (
              <Link
                ...
                className="group flex flex-col items-center justify-center rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 text-center shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-[#E84326]/30 hover:shadow-md"
              >
                ...
                <span className="text-xs font-bold text-[#1A1A2E] dark:text-gray-200 group-hover:text-[#E84326] transition-colors">
                  {g.name}
                </span>
              </Link>
            ))}
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-orange-100 dark:border-gray-800 bg-gradient-to-r from-orange-50/80 via-white to-orange-50/50 dark:from-gray-900 dark:via-gray-850 dark:to-gray-900 p-8 sm:p-10 shadow-sm">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-8 space-y-3">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1A1A2E] dark:text-white">
                {t.home.aituBannerTitle}
              </h2>
              <p className="text-sm text-[#6B7280] dark:text-gray-300 max-w-2xl leading-relaxed">
                {t.home.aituBannerDesc}
              </p>
              <div className="flex flex-wrap gap-4 pt-1">
                <div className="flex items-center gap-2 text-xs font-semibold text-[#1A1A2E] dark:text-gray-200">
                  <CheckCircle2 className="h-4 w-4 text-emerald-500" />
                  <span>{t.home.aituBannerFeature1}</span>
                </div>
                <div className="flex items-center gap-2 text-xs font-semibold text-[#1A1A2E] dark:text-gray-200">
                  <CheckCircle2 className="h-4 w-4 text-emerald-500" />
                  <span>{t.home.aituBannerFeature2}</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 flex justify-start lg:justify-end">
              <Link href="/aitu">
                <button className="inline-flex items-center gap-2 rounded-2xl bg-[#E84326] px-6 py-3.5 text-sm font-extrabold text-white shadow-md shadow-brand-500/25 transition-all hover:bg-[#D63A20] active:scale-95">
                  ...
                  <span>{t.home.aituBannerBtn}</span>
                </button>
              </Link>
            </div>
          </div>
